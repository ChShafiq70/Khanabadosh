      ...
      <div className="px-6 md:px-10 flex flex-col lg:flex-row gap-4 max-w-full mx-auto">
        <div className="lg:w-1/2 text-left py-10">
          ...
          <p className="text-gray-500 mb-6">
            The Medical Alert Home Cellular System supports independent living
            by providing quick and easy access to trained response specialists
            24/7/365. No landline? No problem. The Home Cellular System connects
            you with Medical Alert response specialists through a dependable
            cellular network.
          </p>
          ...
          <div className="flex space-x-4">
            <button className="bg-[#595959] text-white px-8 py-3 ">
              Cellular
            </button>
