...
export default function Hero() {
  return (
    ...
    <div
      ...
      style={{ backgroundImage: "url('/images/cellular.webp')", backgroundSize: "100% 100%" }}
    >
      ...
      <div className="relative text-white text-center max-w-4xl py-2">
        ...
        The MedAlert Home Cellular System promotes independent living by offering easy, 24/7/365 access to trained response specialists. No landline? No problem. The system connects you to MedAlert specialists through a reliable cellular network.
        </p>
