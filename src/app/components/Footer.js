    ...
    <footer className="py-12 px-10 md:px-10 bg-white">
      <div className="py-20 bg-white flex flex-col lg:flex-row items-center justify-between">
        <div className="lg:w-1/2 text-left">
          <p className="text-gray-500 uppercase text-sm font-semibold">Get Your Alerts</p>
          <h2 className="text-4xl font-semibold text-red-500 mt-2">Contact Us And Get Updates</h2>
        </div>      
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Logo & About Section */}
        <div>
          <img src="/images/footer.webp" alt="Shield My Life Logo" className="w-30 mb-4" />
          <p className="text-gray-600 text-sm w-60">
            At ShieldMyLife, we prioritize accurate, timely, and relevant data to enhance medical billing outcomes. Trust in our commitment to informed solutions for your healthcare practice.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-gray-700 text-sm">
            <li className="flex items-center gap-2">
              <MapPin className="w-5 h-5 text-red-500" /> Bogner Drive, Dale City, Virginia
            </li>
            <li className="flex items-center gap-2">
              <Mail className="w-5 h-5 text-red-500" /> support@shieldmylife.com
            </li>
            <li className="flex items-center gap-2">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-gray-700 text-sm">
            ...
            <li><Link href="#" className="hover:text-red-500">Home System</Link></li>
            <li><Link href="#" className="hover:text-red-500">Mobile System</Link></li>
            <li><Link href="#" className="hover:text-red-500">Fall Detection</Link></li>
            <li><Link href="#" className="hover:text-red-500">Smart Watches</Link></li>
          </ul>
        </div>
