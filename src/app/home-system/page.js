...
export default function Hero() {
  return (
    ...
    <div
      ...
      style={{ backgroundImage: "url('/images/homesystem.webp')", backgroundSize: "100% 100%" }}
    >
      ...
      <div className="relative text-white text-center max-w-4xl py-2">
        ...
        <p className="mt-4 text-lg leading-relaxed ">
          The MedAlert Home System promotes independent living by offering 24/7 access to trained response specialists.
          The reliable, easy-to-use, and waterproof help button is perfect for wearing in the shower or tub, where slips and falls are most common.
        </p>
