        ...
        <div className="md:px-20">
         <div className="md:flex gap-2 " >
          {/* <h2 className="text-2xl md:pr-60 md:text-3xl font-bold text-black mb-3"> */}
           <h2 className="item:center text-center text-2xl md:text-3xl font-bold text-black"> ABOUT </h2>  <h2 className= "item:center text-center text-green-700 text-2xl md:text-3xl font-bold">MURREE GLAMPS</h2>
