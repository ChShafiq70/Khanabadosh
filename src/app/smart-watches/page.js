...
export default function Hero() {
  return (
    ...
    <div
      ...
      style={{ backgroundImage: "url('/images/smartwatch.webp')", backgroundSize: "100% 100%" }}
    >
      ...
      <div className="relative text-white text-center max-w-4xl py-2">
        ...
        The Medical Alert Home System promotes independent living by offering 24/7 access to trained response specialists. Designed for reliability and ease of use, the waterproof help button ensures safety even in high-risk areas like the shower or tub, where slips and falls are most common.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-600 text-lg">
                Fall detection automatically alerts help if you can not press the button.
              </p>
            </div>
          </div>
        </div>
    ...
    <section className="py-12 font-poppins">
      <h2 className="text-center text-4xl lad mb-4 tracking-wider">What is Included</h2>
